...
public class Constants {
    ...
    public static final String THINGY1_MAC_ADDRESS_PREF = "thingy1_id_pref";

    public static final String THINGY2_MAC_ADDRESS_PREF = "thingy2_id_pref";

    public static final String SHARE_PREF_USER_LIST = "share_pref_user_list";
    ...
    public static class Config {
        public static final String THINGY1_UUID = "Thingy1UUID";
        public static final String THINGY2_UUID = "Thingy2UUID";
    }
    ...
    public static final String ACTION_THINGY2_BROADCAST = "com.specknet.pdiotapp.THINGY2_BROADCAST";
    public static final String ACTION_THINGY2_CONNECTED = "com.specknet.pdiotapp.THINGY2_CONNECTED";
    public static final String ACTION_THINGY2_DISCONNECTED = "com.specknet.pdiotapp.THINGY2_DISCONNECTED";
    public static final String THINGY2_LIVE_DATA = "thingy2_live_data";

    public static final String ACTION_THINGY1_BROADCAST = "com.specknet.pdiotapp.THINGY1_BROADCAST";
    public static final String ACTION_THINGY1_CONNECTED = "com.specknet.pdiotapp.THINGY1_CONNECTED";
    public static final String ACTION_THINGY1_DISCONNECTED = "com.specknet.pdiotapp.THINGY1_DISCONNECTED";
    public static final String THINGY1_LIVE_DATA = "thingy1_live_data";
