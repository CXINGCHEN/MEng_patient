...
class ConnectingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        thingy1ID = findViewById(R.id.thingy1_code)
        ...
        thingy2ID = findViewById(R.id.thingy2_code)
        ...
        thingy1ID.filters = arrayOf<InputFilter>(AllCaps())

        thingy2ID.filters = arrayOf<InputFilter>(AllCaps())
...
//                }
                ...
                thingy1ID.setText(ble_addr.toString())
